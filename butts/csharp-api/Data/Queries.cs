...
namespace MegaFpCSharpTodoBackEndTotallyNotButtCheeks.Data
{
    public class TodoDto : Record<TodoDto>
    {
        ...
        public TodoDto(TodoId todoId, string description, bool isActive) =>
    ...
    public static class Queries
    {
        ...
        /// <returns></returns>
        public static async Task<Either<string, Lst<TodoDto>>> 
        GetAllTodos(DbSet<Todo> todoDbSet) =>
            await TryAsync(
                todoDbSet
                    .AsNoTracking()
        ...
        public static async Task<Either<Error, Lst<Dto>>> GetAll<Table, Dto, Error>(
            Expression<Func<Table, Dto>> projectExpr,
            Expression<Func<Table, bool>> whereExpr,
            Func<Exception, Error> errorFunc,
            DbSet<Table> dbSet)
        where Table : class
        =>
