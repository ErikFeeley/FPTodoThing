...
namespace MegaFpCSharpTodoBackEndTotallyNotButtCheeks.Controllers
{
    ...
    public class TodosController : ControllerBase
    {
        ...
        public class UpdateTodoDto
        {
            ...
            public static Validation<IEnumerable<ValidationFailure>, UpdateTodoDto> ValidateUpdateTodo(UpdateTodoDto updateTodoDto)
            {
        ...
        [HttpGet]
        public async Task<ActionResult<Lst<TodoDto>>> Get() =>
            (await Queries
                .TryGetAll(
        ...
        public async Task<ActionResult<TodoDto>> Get([FromRoute] int id) =>
            (await Queries
                .TryGetOptional(
                    projectExpr: TodoDto.Projection,
                    filterExpr: todo => todo.TodoId == id,
                    ...
                    SuccAsync: async validatedUpdateTodo =>
                        (await Queries
                            .TryUpdate(
                                projectFunc: TodoDto.FromTodoEntity,
                                filterExpr: todo => todo.TodoId == id,
                                toUpdateFunc: update => new Todo(id, update.Description, update.IsActive),
