...
var author$project$Main$GotTodoMsg = function (a) {
	return {$: 'GotTodoMsg', a: a};
};
var author$project$Main$GotTodosMsg = function (a) {
	return {$: 'GotTodosMsg', a: a};
};
var author$project$Main$Todo = function (a) {
	return {$: 'Todo', a: a};
};
var author$project$Main$Todos = function (a) {
	return {$: 'Todos', a: a};
};
...
var author$project$Page$Todo$GotTodo = function (a) {
	return {$: 'GotTodo', a: a};
};
var author$project$Page$Todo$Loading = {$: 'Loading'};
...
var author$project$Todo$Todo = F3(
	function (todoId, description, isActive) {
		return {description: description, isActive: isActive, todoId: todoId};
	});
...
var author$project$Todo$fetchOne = F2(
	function (toMsg, todoId) {
...
var author$project$Page$Todo$init = function (todoId) {
	return _Utils_Tuple2(
		author$project$Page$Todo$Loading,
		A2(author$project$Todo$fetchOne, author$project$Page$Todo$GotTodo, todoId));
};
var author$project$Page$Todos$GotTodos = function (a) {
	return {$: 'GotTodos', a: a};
};
var author$project$Page$Todos$Loading = {$: 'Loading'};
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$Todo$fetchAll = function (toMsg) {
	return elm$http$Http$get(
		{
			expect: A2(
...
var author$project$Page$Todos$init = _Utils_Tuple2(
	author$project$Page$Todos$Loading,
	author$project$Todo$fetchAll(author$project$Page$Todos$GotTodos));
	...
	return elm$url$Url$Parser$oneOf(
		_List_fromArray(
			[
				...
				A4(author$project$Main$updateWith, author$project$Main$Todos, author$project$Main$GotTodosMsg, model, author$project$Page$Todos$init),
				...
				function (todoId) {
					return A4(
						...
						model,
						author$project$Page$Todo$init(todoId));
				},
				A2(
					elm$url$Url$Parser$slash,
					elm$url$Url$Parser$s('todo'),
...
var author$project$Main$toRoute = F2(
	function (url, model) {
		return A2(
...
var author$project$Main$init = F3(
	function (_n0, url, key) {
		return A2(
			author$project$Main$toRoute,
			url,
			{key: key, page: author$project$Main$Blank});
	});
...
var author$project$Page$Todo$Failure = function (a) {
	return {$: 'Failure', a: a};
};
var author$project$Page$Todo$Success = function (a) {
	return {$: 'Success', a: a};
};
var author$project$Page$Todo$update = F2(
	function (msg, model) {
		if (msg.a.$ === 'Ok') {
			var value = msg.a.a;
			return _Utils_Tuple2(
				author$project$Page$Todo$Success(value),
				elm$core$Platform$Cmd$none);
		} else {
			var httpError = msg.a.a;
			return _Utils_Tuple2(
				author$project$Page$Todo$Failure(httpError),
				elm$core$Platform$Cmd$none);
		}
	});
			...
			default:
				if (_n0.b.$ === 'Todo') {
					...
					return A4(
						...
						author$project$Main$GotTodoMsg,
						model,
						A2(author$project$Page$Todo$update, subMsg, subModel));
				} else {
					var subMsg = _n0.a.a;
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
...
var author$project$Page$Todo$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$Page$Todos$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$href('/todo/1')
					]),
				_List_fromArray(
					[
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Todo.Todo":{"args":[],"type":"{ todoId : Basics.Int, description : String.String, isActive : Basics.Bool }"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"GotTodosMsg":["Page.Todos.Msg"],"GotTodoMsg":["Page.Todo.Msg"]}},"Page.Todo.Msg":{"args":[],"tags":{"GotTodo":["Result.Result Http.Error Todo.Todo"]}},"Page.Todos.Msg":{"args":[],"tags":{"GotTodos":["Result.Result Http.Error (List.List Todo.Todo)"]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}}}}})}});}(this));